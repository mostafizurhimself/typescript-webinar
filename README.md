...
9. What is a tuple in TypeScript?
   ...
   - [x] A type that represents null values
   - [ ] A function that returns multiple values
...
15. What is type assertion in TypeScript?
    ...
    - [x] Automatically converting one type to another
